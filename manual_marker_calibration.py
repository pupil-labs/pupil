    ...
    def recent_events(self, events):
        ...
        if self.active and frame:
            ...
            if self.markers:
                ...
                col_slice = int(marker_pos[0]-second_ellipse[1][0]/2),int(marker_pos[0]+second_ellipse[1][0]/2)
                row_slice = int(marker_pos[1]-second_ellipse[1][1]/2),int(marker_pos[1]+second_ellipse[1][1]/2)
