...
def xmos_grab(q,id,size):
	...
	cam.aptina_setWindowPosition(cam.id0,(0,4))
	cam.aptina_LED_control(cam.id0,Disable = 0,Invert =0)
	cam.aptina_AEC_AGC(cam.id0,0,0) # Auto Exposure Control + Auto Gain Control
...
def main():
	...
	p_grab_eye = Process(target=xmos_grab, args=(eye_q,eye_id,(752,480)))
