...
class Segmentation(Plugin):
    ...
    in accord with custom user defined events.
    ...
    def init_gui(self):
        ...
        self.menu.append(ui.Info_Text('It is possible to auto trim the video and data export using those events. Choose the Trim Mode that fit your needs.'))
