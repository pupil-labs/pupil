...
def export(should_terminate, frames_to_export, current_frame, rec_dir, user_dir, min_data_confidence,
    ...
    vis_plugins = sorted([Vis_Circle, Vis_Cross, Vis_Polyline, Vis_Light_Points, Vis_Watermark, Scan_Path], key=lambda x: x.__name__)
    analysis_plugins = sorted([Manual_Gaze_Correction, Eye_Video_Overlay, Pupil_Angle_3D_Fixation_Detector,
