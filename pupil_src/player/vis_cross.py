...
class Vis_Cross(Plugin):
    ...
    def __init__(self, g_pool=None,inner=20,outer=100,color=(1.,.2,.4,.5),thickness=1):
    ...
    def get_init_dict(self):
        return {'inner':self.inner.value,'outer':self.outer.value,'color':self.color[:],'thickness':self.thickness.value}
