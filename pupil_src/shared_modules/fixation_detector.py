...
class Gaze_Position_2D_Fixation_Detector(Offline_Base_Fixation_Detector):
    ...
    def export_fixations(self,export_range,export_dir):
        ...
        with open(os.path.join(export_dir,'fixations.csv'),'w',encoding='utf-8') as csvfile:
        ...
        with open(os.path.join(export_dir,'fixation_report.csv'),'w',encoding='utf-8') as csvfile:
            csv_writer = csv.writer(csvfile)
