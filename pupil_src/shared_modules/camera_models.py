...
pre_recorded_calibrations = {
    ...
    'Pupil Cam1 ID0':{
        '(320, 240)': {
            'cam_type': 'radial',
            'camera_matrix': [[343.0149710801813, 0.0, 157.84865237871372], [0.0, 335.4891599909332, 122.97163827237306], [0.0, 0.0, 1.0]],
            'dist_coefs': [[0.3041476963498366, -3.0005385715031974, -0.002779733270960017, -0.0022506538299292152, 6.289619298845895]],
        },
        '(640, 480)': {
            'cam_type': 'radial',
            'camera_matrix': [[546.9434829152419, 0.0, 303.5897094603094], [0.0, 532.8321179356755, 243.98091496787148], [0.0, 0.0, 1.0]],
            'dist_coefs': [[0.18880488836369028, -1.0378473021248626, -0.00400530751182626, -0.0035914893144059026, 1.1579165110785485]],
        },
    },
    'Pupil Cam1 ID1':{
        '(320, 240)': {
