...
pre_recorded_calibrations = {
    'Pupil Cam1 ID2':{
        "(640, 480)":{
            'dist_coefs': [[-0.14267936144421778], [-0.006443091880033928], [-0.014239424169280661], [0.016897229961574504]],
            'camera_matrix': [[404.5322128736885, 0.0, 320.58224317882826], [0.0, 390.2657829403118, 228.86222319951628], [0.0, 0.0, 1.0]],
            'cam_type': 'fisheye'
            },
        "(1280, 720)":{
