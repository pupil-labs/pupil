...
class Color_RGB(Color):
    ...
    @property
    def red(self) -> int: return self.channels[0]

    @property
    def green(self) -> int: return self.channels[1]

    @property
    def blue(self) -> int: return self.channels[2]
...
class Color_RGBA(Color):
    ...
    def __init__(self, red: float, green: float, blue: float, alpha: float):
        ...
        self._channels = (clip_float(red), clip_float(green), clip_float(blue), clip_float(alpha))

    @property
    def red(self) -> float: return self.channels[0]

    @property
    def green(self) -> float: return self.channels[1]

    @property
    def blue(self) -> float: return self.channels[2]

    @property
    def alpha(self) -> float: return self.channels[3]
