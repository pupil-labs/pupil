...
class Annotation_Capture(Plugin):
    ...
    def update_buttons(self):
        ...
        for e_name, hotkey in self.annotation_definitions:
            ...
            self.sub_menu.append(
                ui.Button(e_name + " <" + hotkey + ">", make_remove(e_name, hotkey))
            )
    ...
    def append_annotation(self):
        self.annotation_definitions.append(
            (self.new_annotation_name, self.new_annotation_hotkey)
        )
        self.update_buttons()
...
class Annotation_Player(Annotation_Capture, Analysis_Plugin_Base):
    ...
    def load_cached_annotations(self):
        ...
        self.annotations = pm.Mutable_Bisector(annotations.data, annotations.timestamps)
    ...
    def extract_annotations_from_recorded_notifications(self):
        ...
        logger.info(
            "Extracted {} annotations from recording.".format(len(self.annotations))
        )
