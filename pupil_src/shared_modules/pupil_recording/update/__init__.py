...
from pupil_recording.update.old_style import (
...
from pupil_recording.update.mobile import (
...
from pupil_recording.recording import get_recording_type, RecordingType
