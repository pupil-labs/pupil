...
class Eye_Visualizer(Visualizer):
    ...
    def get_pupil_transformation_matrix(
    ...
    def draw_debug_info(self, result):
        ...
        for model in models:
            ...
            self.glfont.draw_multi_line_text(
                self.window_size[0] - 200, delta_y, modeltext
            )
    ...
    def update_window(self, g_pool, result):
        ...
        for model in sphere_models:
            ...
            if model_count == 0:
                ...
                self.draw_sphere(
                    sphere[0], sphere[1], color=alternative_initial_sphere_color
                )
