...
def extract_2d_data_monocular(matched_data):
    """"
...
def extract_2d_data_binocular(matched_data):
    """
    Takes matched pupil data and returns list of tuples, keeping only the positions
...
def extract_3d_data(matched_data, g_pool):
    """
    Takes matched data, splits into pupil0, pupil1, ref, keeping only the normals and
    unprojections, respectively.
    """
