...
def finish_calibration(g_pool,pupil_list,ref_list):
    ...
    g_pool.active_calibration_plugin.notify_all({'subject':'calibration.calibration_data','timestamp':g_pool.get_timestamp(),'pupil_list':pupil_list,'ref_list':ref_list,'calibration_method':method,'record':True})
