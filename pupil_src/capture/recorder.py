...
class Recorder(Plugin):
    """Capture Recorder"""
    def __init__(self,g_pool,session_name = get_auto_name(),user_info={'name':'','addional_field':'change_me'},info_menu_conf={},show_info_menu=False, record_eye = False, audio_src = -1, menu_conf = {}):
    ...
    def init_gui(self):
        ...
        self.menu.append(ui.Switch('show_info_menu',self,on_val=True,off_val=False,label='Request addional user info'))
    ...
    def open_info_menu(self):
        self.info_menu = ui.Growing_Menu('Addional Recording Info',size=(300,300),pos=(300,300))
