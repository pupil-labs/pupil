...
class MSER_Detector(Pupil_Detector):
    ...
    def detect(self,frame,u_roi,p_roi,visualize=False):
        img = frame.img
        debug= True
        PARAMS = {'_delta':10, '_min_area': 2000, '_max_area': 10000, '_max_variation': .25, '_min_diversity': .2, '_max_evolution': 200, '_area_threshold': 1.01, '_min_margin': .003, '_edge_blur_size': 5}
        pupil_intensity= 150
        pupil_ratio= 2
