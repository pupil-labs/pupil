...
from user_events import User_Event_Capture
...
def world(g_pool,cap_src,cap_size):
    ...
    user_launchable_plugins = [Show_Calibration,Pupil_Server,Pupil_Sync,Marker_Detector,User_Event_Capture]+runtime_plugins
