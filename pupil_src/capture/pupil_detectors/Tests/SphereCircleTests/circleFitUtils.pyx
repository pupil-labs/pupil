...
cdef extern from "CircleOnSphereUtils.h":
    ...
    Vector3 test_haversine( Vector2 center, double opening_angle_alpha, int amount )
...
def testHaversine(center , opening_angle_alpha , amount):
    cdef Vector2 center_point
    center_point[0] = center[0]
    center_point[1] = center[1]
    result = test_haversine( center_point, opening_angle_alpha, amount)
